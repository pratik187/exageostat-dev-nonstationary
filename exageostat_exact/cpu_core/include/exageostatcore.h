...
void core_dcmg_non_stat_estimation(double *A, int m, int n, int m0, int n0, location *l1, location *l2, location *lm, 
        double *localtheta, non_stat_params *ns_params, int distance_metric, int Nsplit);
