 ...
 * */
{
    ...
    EXAGEOSTAT_MLE_dcmg_Tile_Async(ChamLower, CHAM_descC22, &data->lobs, &data->lobs,&data->ns_params, 
                                  &data->lm, theta, data->dm, data->kernel_fun, data->Nsplit , msequence, mrequest);
    CHAMELEON_Sequence_Wait(msequence);
    VERBOSE(" Done.\n");
    ...
    EXAGEOSTAT_MLE_dcmg_Tile_Async(ChamLower, CHAMELEON_descr, &data->lobs, &data->lmiss,
                                  &data->lm, &data->ns_params, theta, data->dm, data->kernel_fun, data->Nsplit ,msequence, mrequest);
    CHAMELEON_Sequence_Wait(msequence);
    VERBOSE(" Done.\n");
 ...
 * */
{
    ...
    EXAGEOSTAT_MLE_dcmg_Tile_Async(ChamLower, CHAM_descC22, l2, l2, &data->lm, &data->ns_params, theta, data->dm, data->kernel_fun,
                                  data->Nsplit ,msequence, mrequest);
    VERBOSE(" Done.\n");

    //Generate C12 covariance matrix
    VERBOSE("Generate C12 Covariance Matrix... (Prediction Stage)");
    EXAGEOSTAT_MLE_dcmg_Tile_Async(ChamLower, CHAM_descC12, l1, l2, &data->lm, &data->ns_params,theta, data->dm, data->kernel_fun,
                                  data->Nsplit ,msequence, mrequest);
    VERBOSE(" Done.\n");
    STOP_TIMING(mat_gen_time);
 ...
 * */
{
    ...
    EXAGEOSTAT_MLE_dcmg_Tile_Async(ChamLower, CHAMELEON_descK_a, &data->lobs, &data->lobs, &data->lm, &data->ns_params, estimated_theta,
                                  data->dm, data->kernel_fun,data->Nsplit ,msequence, mrequest);
    CHAMELEON_Sequence_Wait(msequence);
    //(2)Generate the co-variance matrix descK_t
    EXAGEOSTAT_MLE_dcmg_Tile_Async(ChamLower, CHAMELEON_descK_t, &data->lobs, &data->lobs, &data->lm, &data->ns_params, truth_theta,
                                  data->dm, data->kernel_fun,data->Nsplit ,msequence, mrequest);
    CHAMELEON_Sequence_Wait(msequence);
    VERBOSE(" Done.\n");
    ...
    for (p = 0; p < nZmiss; p++) {
        ...
        EXAGEOSTAT_MLE_dcmg_Tile_Async(ChamUpperLower, CHAMELEON_desck_t, &data->lobs, &lmiss, &data->lm, &data->ns_params, truth_theta,
                                      data->dm, data->kernel_fun, data->Nsplit ,msequence, mrequest);
        EXAGEOSTAT_MLE_dcmg_Tile_Async(ChamUpperLower, CHAMELEON_desck_a, &data->lobs, &lmiss, &data->lm,&data->ns_params, 
                                      estimated_theta, data->dm, data->kernel_fun, data->Nsplit ,msequence, mrequest);
        CHAMELEON_Sequence_Wait(msequence);
