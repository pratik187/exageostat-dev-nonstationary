 ...
 * */
{
    ...
    if (strcmp(data->kernel_fun, "bivariate_matern_parsimonious2") == 0 ||
        ...
        EXAGEOSTAT_MLE_dcmg_Tile_Async(ChamUpperLower, data->descsubC22, &data->l1, &data->l1,
                                      &data->lm, univariate3_theta, &data->ns_params, data->dm,
    ...
    if (strcmp(data->recovery_file, "") != 0 &&
        ...
        if (strcmp(data->kernel_fun, "bivariate_matern_parsimonious2") == 0 ||
            ...
            EXAGEOSTAT_MLE_dcmg_Tile_Async(ChamUpperLower, CHAM_descsubC11, &data->l1,
                                          &data->l1, &data->lm, univariate_theta, &data->ns_params, data->dm,
                                          "univariate_matern_stationary",data->Nsplit , msequence, &mrequest[0]);
...
double EXAGEOSTAT_dmle_Tile_Async(unsigned n, const double*theta, double*grad, void *CHAM_data) {
    ...
    EXAGEOSTAT_MLE_dcmg_Tile_Async(ChamLower, CHAM_descC, &data->l1, &data->l1, &data->lm, (double*) theta, &data->ns_params, data->dm,
                                  data->kernel_fun, data->Nsplit ,msequence, &mrequest[0]);
    CHAMELEON_Sequence_Wait(msequence);
    STOP_TIMING(matrix_gen_time);
    VERBOSE(" Done.\n");
 ...
 * */
{
    ...
    EXAGEOSTAT_MLE_dcmg_Tile_Async(ChamLower, CHAM_descC22, &data->lmiss, &data->lmiss, &data->lm, theta, &data->ns_params, 
        data->dm, data->kernel_fun, data->Nsplit ,  msequence, mrequest);
    CHAMELEON_Sequence_Wait(msequence);
    VERBOSE(" Done.\n");
    ...
    EXAGEOSTAT_MLE_dcmg_Tile_Async(ChamLower, CHAM_descC12, &data->lmiss, &data->lmiss, &data->lm, theta, &data->ns_params, 
        data->dm, data->kernel_fun, data->Nsplit ,  msequence, mrequest);
    CHAMELEON_Sequence_Wait(msequence);
    VERBOSE(" Done.\n");
 ...
 * */
{
    ...
    EXAGEOSTAT_MLE_dcmg_Tile_Async(ChamLower, CHAM_descC22, l2, l2, &data->lm, theta, &data->ns_params, 
        data->dm, data->kernel_fun, data->Nsplit ,   msequence, mrequest);
    VERBOSE(" Done.\n");
    ...
    EXAGEOSTAT_MLE_dcmg_Tile_Async(ChamLower, CHAM_descC12, l1, l2, &data->lm, theta, &data->ns_params, 
        data->dm, data->kernel_fun, data->Nsplit ,  msequence, mrequest);
    VERBOSE(" Done.\n");
    STOP_TIMING(mat_gen_time);
 ...
 * */
{
    ...
    EXAGEOSTAT_MLE_dcmg_Tile_Async(ChamLower, CHAM_descK_a, &data->lobs, &data->lobs, &data->lm, estimated_theta,&data->ns_params, 
                                  data->dm, data->kernel_fun, data->Nsplit , msequence, mrequest);
    CHAMELEON_Sequence_Wait(msequence);
    ...
    EXAGEOSTAT_MLE_dcmg_Tile_Async(ChamLower, CHAM_descK_t, &data->lobs, &data->lobs, &data->lm, truth_theta, &data->ns_params, 
        data->dm, data->kernel_fun, data->Nsplit ,  msequence, mrequest);
    CHAMELEON_Sequence_Wait(msequence);
    VERBOSE(" Done.\n");
        ...
        if(CHAMELEON_My_Mpi_Rank() == 0)
    {
        ...
        EXAGEOSTAT_MLE_dcmg_Tile_Async(ChamUpperLower, CHAM_desck_t, &data->lobs, &lmiss, &data->lm, truth_theta,&data->ns_params, 
                                      data->dm, data->kernel_fun, data->Nsplit ,msequence, mrequest);
        EXAGEOSTAT_MLE_dcmg_Tile_Async(ChamUpperLower, CHAM_desck_a, &data->lobs, &lmiss, &data->lm, estimated_theta,&data->ns_params, 
                                      data->dm, data->kernel_fun, data->Nsplit ,msequence, mrequest);
        CHAMELEON_Sequence_Wait(msequence);
...
double*EXAGEOSTAT_Fisher_Tile(MLE_data *data, int N, double*initial_theta, int dts, int p_grid, int q_grid) {
    ...
    EXAGEOSTAT_MLE_dcmg_Tile_Async(ChamLower, CHAM_descC, &data->l1, &data->l1, &data->lm, initial_theta,&data->ns_params,
                                  data->dm, "univariate_matern_stationary", data->Nsplit , data->sequence, data->request);
    VERBOSE("...Done\n");
    CHAMELEON_Sequence_Wait(data->sequence);
    ...
    for (int j = 0; j < 3; j++) {
        ...
        EXAGEOSTAT_MLE_dcmg_Tile_Async(ChamUpperLower, CHAM_descCJ, &data->l1, &data->l1, &data->lm, initial_theta,&data->ns_params,
                                      data->dm, kernel,data->Nsplit , data->sequence, data->request);
        VERBOSE("...Done\n");
        CHAMELEON_Sequence_Wait(data->sequence);
        ...
        for (int k = j; k < 3; k++) {
            ...
            VERBOSE("Generate covariance matrix  CHAM_descCJ  (Fisher Matrix Generation).....");
            EXAGEOSTAT_MLE_dcmg_Tile_Async(ChamUpperLower, CHAM_descCK, &data->l1, &data->l1, &data->lm, initial_theta,&data->ns_params,
                                          data->dm, kernel, data->Nsplit ,data->sequence, data->request);
            VERBOSE("...Done\n");
            CHAMELEON_Sequence_Wait(data->sequence);
