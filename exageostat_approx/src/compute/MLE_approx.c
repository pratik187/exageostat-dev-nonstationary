 ...
 * */
{
    ...
    if (strcmp(data->kernel_fun, "bivariate_matern_parsimonious2") == 0 ||
        ...
        EXAGEOSTAT_MLE_dcmg_Tile_Async(ChamUpperLower, data->descsubC11, &data->l1, &data->l1, &data->lm,
                                      univariate_theta,&data->ns_params, data->dm, "univariate_matern_stationary", data->Nsplit, msequence,
                                      &mrequest[0]);
        ...
        EXAGEOSTAT_MLE_dcmg_Tile_Async(ChamUpperLower, data->descsubC12, &data->l1, &data->l1, &data->lm,
                                      univariate2_theta, &data->ns_params,data->dm, "univariate_matern_stationary", data->Nsplit,msequence,
                                      &mrequest[0]);
        ...
        EXAGEOSTAT_MLE_dcmg_Tile_Async(ChamUpperLower, data->descsubC22, &data->l1, &data->l1, &data->lm,
                                      univariate3_theta, &data->ns_params,data->dm, "univariate_matern_stationary", data->Nsplit,msequence,
                                      &mrequest[0]);
 ...
 * */
{
    ...
    EXAGEOSTAT_MLE_dcmg_Tile_Async(ChamLower, data->descC, &data->l1, &data->l1, &data->lm, initial_theta, &data->ns_params,data->dm,
