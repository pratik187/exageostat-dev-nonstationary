...
EXAGEOSTAT_TLR_MLE_dzvg_Tile(MLE_data *data, double *Nrand, double *initial_theta, int n, int dts, int log, int p_grid,
    ...
    if (strcmp(data->kernel_fun, "bivariate_matern_parsimonious2") == 0 ||
        ...
        EXAGEOSTAT_MLE_dcmg_Tile_Async(ChamUpperLower, chameleon_desc_submatrix(CHAM_descC, CHAM_descC->m / 2,
                                       ...
                                       univariate2_theta, &data->ns_params,
                                       data->dm, "univariate_matern_stationary",data->Nsplit, msequence,
                                       mrequest);
        ...
        EXAGEOSTAT_MLE_dcmg_Tile_Async(ChamUpperLower, chameleon_desc_submatrix(CHAM_descC, CHAM_descC->m / 2,
                                                                                ...
                                                                                CHAM_descC->n / 2), &data->l1,
                                       &data->l1,
                                       &data->lm, univariate3_theta, &data->ns_params,
                                       data->dm, "univariate_matern_stationary",data->Nsplit,
                                       msequence,
                                       mrequest);
 ...
 * */
{
    ...
    EXAGEOSTAT_MLE_dcmg_Tile_Async(ChamLower, CHAM_descC12, &data->lmiss, &data->lobs, &data->lm, theta, &data->ns_params,data->dm,
                                   data->kernel_fun,data->Nsplit, hsequence, hrequest);
    CHAMELEON_Sequence_Wait(hsequence);
