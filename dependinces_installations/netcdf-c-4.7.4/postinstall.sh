...
if [ "x$DOAUTOTOOL" = "xTRUE" ]; then
    ...
    if [ "x$DOACTION" = "xbuild" ]; then
        ...
        LIBS="-lhdf5_hl -lhdf5 -lm -ldl -lz " CFLAGS="-I/home/nagp/exageostat-dev/dependinces_installations/include" LDFLAGS="-L/home/nagp/exageostat-dev/dependinces_installations/lib" ./configure --prefix=/home/nagp/exageostat-dev/dependinces_installations $STATIC_BUILD $SHARED_BUILD
